        ...
        while(true){
            ...
            switch(choice){
                case 1: {
                    ...
                    System.out.println("\nThe area of the mentioned rectangle is : "+rectangleshape.area()+"sqcm");
                    break;
                } 
                ...
                case 2: {
                    ...
                    ShapeCalculate rectangleshape= new Rectangle(length, breadth);
                    System.out.println("\nThe perimeter of the mentioned rectangle is : "+rectangleshape.perimeter()+"cm");
                    break;
                } 
                ...
                case 3: {
                    ...
                    System.out.println("\nThe area of the mentioned rectangle is : "+circleshape.area()+"sqcm");
                    break;
                } 
                ...
                case 4: {
                    ...
                    ShapeCalculate circleshape= new Circle(radius);
                    System.out.println("\nThe perimeter of the mentioned rectangle is : "+circleshape.perimeter()+"cm");
                    break;
                } 
